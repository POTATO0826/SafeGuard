// OriginKit "Text Path" — adapted for Vite + React 19
// (Framer RenderTarget/Font-control bindings removed; defaultProps converted)
...
export default function TextPath({
  ...
  speed = 30,
  reversed = true,
  textFont = { fontSize: 40, letterSpacing: 1 },
  textColor = "#FFFFFF",
  waveFrequency = 3,
  waveHeight = 100,
  separator = "   •   ",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <text fill={textColor} style={{ fontSize, letterSpacing, fontFamily, fontWeight, fontStyle }}>
